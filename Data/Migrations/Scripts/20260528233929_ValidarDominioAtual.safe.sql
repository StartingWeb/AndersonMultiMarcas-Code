/*
  Migration segura: 20260528233929_ValidarDominioAtual
  Objetivo: NÃO destruir dados existentes; criar apenas o que não existir.
*/
...
IF NOT EXISTS (SELECT 1 FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20260528233929_ValidarDominioAtual')
BEGIN
    BEGIN TRANSACTION;
